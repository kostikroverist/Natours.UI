...
const TourItem: React.FC<TourItemProps> = ({ tourData }) => {
  const { name, imageCover, difficulty, duration, price, locations, guides, summary, startLocation, startDates, maxGroupSize, ratingsAverage, ratingsQuantity, _id } = tourData;
